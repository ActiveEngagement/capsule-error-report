...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* reexport */ SlideDeck; });

// UNUSED EXPORTS: SlideDeckControls, Slides
...
/* harmony default export */ var Slidesvue_type_script_lang_js_ = ({
    ...
    methods: {
        ...
        findSlideByQuerySelector(selector) {
            return Object(utils["c" /* first */])(this.findSlidesByQuerySelector(selector));
        },
         ...
         */
        findSlideByKey(key) {
            return Object(utils["c" /* first */])(this.slides().filter((vnode) => {
                if(vnode.key === key) {
                    return vnode;
                }
        ...
        getSlideIndex(slide) {
            ...
            if(slide && !Object(utils["g" /* isUndefined */])(slide.data)) {
                key = slide.data.key;
            }
            ...
            return Object(utils["b" /* findIndex */])(this.slides(), (vnode, i) => {
                if(slide === vnode) {
                    return true;
                }
                else if(vnode.data && vnode.data.key === key) {
...
var Slides_component = Object(componentNormalizer["a" /* default */])(
...
/* harmony default export */ var SlideDeckvue_type_script_lang_js_ = ({
    ...
    methods: {
        ...
        resize(el) {
            if(Object(utils["d" /* isFunction */])(this.resizeMode)) {
        ...
        onSlideEnter(el, done) {
            ...
            Object(utils["j" /* transition */])(el).then(delay => {
